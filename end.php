<?php
	...
	$q = "INSERT INTO survey1 (`university`, `specialty`, `social_life`, `study_load`, `exchange`, `equipped_laboratories`, `education_lang`, `work_by_profession`) VALUES ('".$all['university']."', '".$all['speciality_name']."',".$_POST['social_life'].",".$_POST['study_load'].",".$_POST['exchange'].",".$_POST['equipped_laboratories'].",".$_POST['education_lang'].",".$_POST['work_by_profession'].")";
